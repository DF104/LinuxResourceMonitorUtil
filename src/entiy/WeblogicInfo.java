...
public class WeblogicInfo extends ServerInfo{
	...
	public WeblogicInfo(Integer weblogicId, String host, String port, String username,
			String password, String mark, String time) {
		super();
	...
	public String toString() {
		return "WeblogicInfo [weblogicId=" + weblogicId + ", host=" + host
